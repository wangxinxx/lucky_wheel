      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6">
          <figure class="figure mb-0">
            <img src="static/uploads/pdMarket_img/market1920_03.png" class="figure-img rounded logo">
          </figure>
        </div>
        <div class="col-lg-6 col-md-4"></div>
      </div>
      <div class="row ml-67-lock-ratio lucky-wheel-main">
        <img src="static/uploads/bigDial_img/list_1920_03.png" class="lucky-wheel-result-bg">
        <img src="static/uploads/bigDial_img/qrcode_1920_06.png" class="lucky-wheel-qrcode">
        <!--      lucky-wheel start-->
        <div class="container">
