!function (a) {
    ...
    b.prototype = {
        _generate: function () {
            ...
            var b = this, c = Math.ceil(this.$el.innerWidth()), d = Math.ceil(this.$el.innerHeight()),
            ...
            this.$el.children().remove(), a.removeData(this.$el, "JGguagua")
    ...
    }, a.support.canvas = document.createElement("canvas").getContext, a.fn.JGguagua = function (c, d) {
        function e() {
            // var d = a.data(this, "JGguagua");
            var d;
            // return d || (d = new b(this, a.extend(!0, {}, c)), a.data(this, "JGguagua", d)), d
            return (d = new b(this, a.extend(!0, {}, c)), a.data(this, "JGguagua", d)), d
        }

        if ("string" == typeof c) {
            var f, g = [], h = (void 0 !== d ? "set" : "get") + c.charAt(0).toUpperCase() + c.substring(1),
                i = function () {
                    f.options[c] && (f.options[c] = d), f[h] && f[h].apply(f, [d])
                }, j = function () {
                    return f[h] ? f[h].apply(f, [d]) : f.options[c] ? f.options[c] : void 0
                }, k = function () {
                    f = a.data(this, "JGguagua"), f && (f[c] ? f[c].apply(f, [d]) : void 0 !== d ? i() : g.push(j()))
                };
            return this.each(k), g.length ? 1 === g.length ? g[0] : g : this
        }
        return c = a.extend({}, a.fn.JGguagua.defaults, c), this.each(e)
    }, a.fn.JGguagua.defaults = {
        size: 5,
        bg: "#cacaca",
        fg: "#6699ff",
        realtime: !0,
